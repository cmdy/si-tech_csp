...
BEGIN
DELETE FROM TB_KUBE_CONF_CONT_DOCK WHERE INSERT_TIME < DATE_SUB(NOW(), INTERVAL 1 DAY);
DELETE FROM TB_KUBE_PERF_CONT_CPUMEM WHERE INSERT_TIME < DATE_SUB(NOW(), INTERVAL 1 DAY);
DELETE FROM TB_KUBE_PERF_CONT_FILESYSTEM WHERE INSERT_TIME < DATE_SUB(NOW(), INTERVAL 1 DAY);
DELETE FROM TB_KUBE_PERF_CONT_NETWORK_INTERFACE WHERE INSERT_TIME < DATE_SUB(NOW(), INTERVAL 1 DAY);
DELETE FROM TB_KUBE_PERF_DOCK_CPUMEM WHERE INSERT_TIME < DATE_SUB(NOW(), INTERVAL 1 DAY);
